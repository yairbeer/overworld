...
## Tools
- **[palette_viewer.html](palette_viewer.html)**: An interactive web-based color palette viewer. Load the official color palette (requires 04_color_palette.csv) to browse colors by category, preview them visually, and copy hex codes to your clipboard. Supports drag-and-drop CSV uploads for custom palettes.
